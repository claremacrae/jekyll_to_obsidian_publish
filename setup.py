...
setup(
    name="jekyll_to_obsidian_publish",
    version=VERSION,
    description="Script to convert markdown files from Jekyll format to Obsidian Publish",
    author="Clare Macrae",
    author_email="",
    url="https://github.com/claremacrae/jekyll_to_obsidian_publish",
